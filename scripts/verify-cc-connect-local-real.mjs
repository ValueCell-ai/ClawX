...
const COVERAGE_IDS = [
  ...
  'bridge-media-send-real-bundle',
  'bridge-rich-packets-local-diagnostics',
  'bridge-rich-progress-real-bundle',
  'bridge-rich-card-action-real-bundle',
  'bridge-runtime-choice-real-bundle',
  ...
  return [
    ...
    },
    {
      ...
      covers: [
        ...
        'file/audio/video preview suppression',
      ],
    ...
    },
    {
      ...
      covers: [
        ...
        'ClawX-managed media copies with exact byte preservation',
        'Host API session history attachment merge',
        'renderer final-event message-id deduplication and session routing',
        'GUI image preview plus PDF/audio/video file cards',
        'sanitized screenshot and structured evidence artifacts',
      ],
      evidence: compile.command || compile.reason,
      reason: compile.reason,
    },
    {
      ...
      covers: [
        ...
        'structured progress delete preserves semantic tool lifecycle',
    ...
    },
    {
      ...
      covers: [
        ...
        'deterministic Codex app-server protocol boundary without direct ClawX-to-Codex chat',
        'public Bridge preview_start and update_message packets observed in runtime diagnostics',
        'thinking and tool lifecycle projected into the shared runtime graph',
    ...
    },
    {
      ...
      covers: [
        ...
        'select option action validated against the public Bridge card payload',
        'GUI action returned through the public card_action packet',
        'updated card closes the Chat run without restarting cc-connect',
        'live language state verified through the public Management project API',
        'sanitized before/after screenshots and structured evidence artifacts',
      ],
      evidence: runtimeManagementBundle.command || runtimeManagementBundle.reason,
      reason: runtimeManagementBundle.reason,
    },
    ...
    },
    {
      ...
      status: runtimeManagementBundle.status,
      covers: [
        'public Bridge channel adapter registration against the real bundled cc-connect binary',
    ...
    },
    {
      ...
      covers: [
        ...
        'runtime PID preservation',
        'Cron page job card and sanitized machine/visual evidence',
