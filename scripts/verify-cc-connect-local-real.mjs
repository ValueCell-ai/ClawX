...
const RESIDUAL_VALIDATION_GAPS = [
  ...
  },
  {
    ...
    status: 'unverified',
    requiredForLocalReplacementGate: false,
    nextCommand: 'Add real cc-connect standalone buttons, preview, update-message, and delete-message packet smokes once those upstream paths are stable.',
    reason: 'Real OAuth covers Codex apply_patch-generated file cards, a real v1.4.1 Bridge channel probe proves a /cron list card plus actionable disable/enable/delete callbacks, and bundled cc-connect send proves image/file/audio/video packets through managed history and GUI rendering. Standalone buttons and preview/update/delete-message packet delivery remain unverified beyond adapter diagnostics.',
  },
  {
