...
Когда активная ACP-сессия OpenClaw сообщает об использовании контекста, в композиторе отображается компактное кольцо. Наведите на него курсор или сфокусируйте его, чтобы увидеть локализованный процент и количество использованных/всех токенов. Кольцо использует только метаданные активного ACP `usage_update` и скрыто при отсутствии или недействительности этих данных.
