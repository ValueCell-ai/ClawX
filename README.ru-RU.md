...
> Полное описание возможностей доступно в [docs/en-US/features.md](docs/en-US/features.md).
...
> Подробности о резервном поведении прокси, синхронизации с Telegram и **OpenClaw Doctor** см. в [docs/en-US/proxy-settings.md](docs/en-US/proxy-settings.md).
...
> Схема процессов, координация конфигурации, семантика файловых операций ACP и устранение неполадок Gateway описаны в [docs/en-US/architecture.md](docs/en-US/architecture.md).
...
- **Linux (Ubuntu/Debian)**: перед запуском Electron установите необходимые системные библиотеки; см. [docs/en-US/development.md](docs/en-US/development.md)
...
> Структура проекта, полный список команд, политика параллельности E2E, диагностика производительности, проверки регрессий коммуникаций и технологический стек описаны в [docs/en-US/development.md](docs/en-US/development.md).
