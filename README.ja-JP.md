...
pnpm run verify:cc-connect:local-real:scheduled-cron # 実スケジュール exec cron を実行し、Codex auth がある場合は ClawX cc-connect bridge fallback 経由の scheduled prompt 配信も検証
