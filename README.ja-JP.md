...
- **設定 → 詳細 → 開発者** の Runtime Doctor は、OpenClaw では `openclaw doctor --json`、cc-connect では同梱の `cc-connect doctor user-isolation` を実行します。Doctor Fix は OpenClaw 専用です。
