...
acceptance:
  ...
  - The chat-protocol request body follows OpenAI's input_audio schema (bare Base64 `data`, explicit `format: 'wav'`, `stream: false`) without vendor extensions such as `asr_options` or Data-URI preludes.
