...
title: Preserve OpenClaw ACP ledger integrity for compaction and trailing chunks
scenario: gateway-backend-communication
taskType: runtime-bridge
intent: Ensure OpenClaw ACP records direct recovery compactions and shorter non-prefix trailing assistant chunks in its event ledger without replacing complete ledger replay from transcript prose.
touchedAreas:
