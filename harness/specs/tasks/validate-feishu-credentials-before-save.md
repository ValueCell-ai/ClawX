...
acceptance:
  ...
  - validateChannelCredentials('feishu') POSTs to <origin>/open-apis/auth/v3/tenant_access_token/internal via proxyAwareFetch, honours domain=lark, and maps a non-zero code to feishuRejected and a thrown fetch to feishuConnectionError without throwing.
