...
- **🎙️ Voice Dictation**: Dictate into the chat composer — the mic button records your voice, transcribes it through a user-configured OpenAI-compatible speech-to-text service, and inserts the text at the cursor. Set it up under **Models -> Speech-to-text** with presets for OpenAI, Groq, SiliconFlow, or a custom endpoint.
