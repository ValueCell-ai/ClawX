...
export const PROVIDER_DEFINITIONS: ProviderDefinition[] = [
  ...
  },
  {
    ...
    showModelId: true,
    // GLM-5.3 on SiliconFlow is 1M-context but text-only; the multimodal
    // sibling is `zai-org/GLM-5.3-Flash`.
  ...
  },
  {
    ...
    providerConfig: {
      ...
      models: [
        ...
        {
          // GLM-5.3 shares the 1M window but takes text only; Flash is the
          // first natively multimodal model in the GLM-5 series.
          id: 'glm-5.3',
          name: 'GLM-5.3',
          reasoning: true,
          input: ['text'],
