...
export type HostApiContract = {
  ...
  settings: {
    ...
    set: (payload: SettingsSetPayload) => MaybePromise<HostSuccess>;
    setMany: (payload: SettingsSetManyPayload) => MaybePromise<HostSuccess>;
    reset: () => MaybePromise<SettingsResetResult>;
  };
  gateway: {
    status: () => MaybePromise<GatewayStatus>;
    start: () => MaybePromise<HostSuccess>;
    stop: () => MaybePromise<HostSuccess>;
    restart: () => MaybePromise<HostSuccess>;
    health: (payload?: GatewayHealthPayload) => MaybePromise<GatewayHealth>;
    controlUi: (payload?: GatewayControlUiPayload) => MaybePromise<GatewayControlUiResult>;
    rpc: (payload: GatewayRpcPayload) => MaybePromise<unknown>;
  };
  logs: {
    recent: (payload?: LogRecentPayload) => MaybePromise<LogContentResult>;
    memory: (payload?: LogMemoryPayload) => MaybePromise<string[]>;
    dir: () => MaybePromise<LogDirResult>;
    filePath: () => MaybePromise<LogFilePathResult>;
    listFiles: () => MaybePromise<LogFilesResult>;
    readFile: (payload: LogReadFilePayload) => MaybePromise<LogContentResult>;
  };
  channels: {
    configured: () => MaybePromise<ChannelConfiguredResult>;
    accounts: (payload?: ChannelAccountsPayload) => MaybePromise<ChannelAccountsResult>;
    targets: (payload: ChannelTargetsPayload) => MaybePromise<ChannelTargetsResult>;
    setDefaultAccount: (payload: ChannelRequiredAccountPayload) => MaybePromise<HostSuccess>;
    bindingSave: (payload: ChannelBindingSavePayload) => MaybePromise<HostSuccess>;
    bindingDelete: (payload: ChannelBindingDeletePayload) => MaybePromise<HostSuccess>;
    validateConfig: (payload: ChannelTypePayload) => MaybePromise<HostSuccess>;
    validateCredentials: (payload: ChannelCredentialValidationPayload) => MaybePromise<ChannelCredentialValidationResult>;
    saveConfig: (payload: ChannelSaveConfigPayload) => MaybePromise<ChannelSaveConfigResult>;
    setEnabled: (payload: ChannelSetEnabledPayload) => MaybePromise<HostSuccess>;
    formValues: (payload: ChannelAccountPayload) => MaybePromise<ChannelFormValuesResult>;
    deleteConfig: (payload: ChannelAccountPayload) => MaybePromise<HostSuccess>;
    startLogin: (payload: ChannelAccountPayload) => MaybePromise<HostSuccess>;
    cancelLogin: (payload: ChannelAccountPayload) => MaybePromise<HostSuccess>;
  };
  agents: {
    list: () => MaybePromise<AgentSnapshotResult>;
    create: (payload: AgentCreatePayload) => MaybePromise<AgentSnapshotResult>;
    update: (payload: AgentUpdatePayload) => MaybePromise<AgentSnapshotResult>;
    updateModel: (payload: AgentUpdateModelPayload) => MaybePromise<AgentSnapshotResult>;
    delete: (payload: AgentIdPayload) => MaybePromise<AgentSnapshotResult>;
    assignChannel: (payload: AgentChannelPayload) => MaybePromise<AgentSnapshotResult>;
    removeChannel: (payload: AgentChannelPayload) => MaybePromise<AgentSnapshotResult>;
  };
  diagnostics: {
    gatewaySnapshot: () => MaybePromise<DiagnosticsGatewaySnapshotResult>;
  };
  providers: {
    list: () => MaybePromise<ProviderWithKeyInfo[]>;
    get: (payload: ProviderIdPayload) => MaybePromise<ProviderConfig | null>;
    getDefault: () => MaybePromise<ProviderConfig | null>;
    hasApiKey: (payload: ProviderIdPayload) => MaybePromise<boolean>;
    getApiKey: (payload: ProviderIdPayload) => MaybePromise<string | null>;
    validateKey: (payload: ProviderValidationPayload) => MaybePromise<ProviderValidationResult>;
    save: (payload: ProviderSavePayload) => MaybePromise<HostSuccess>;
    delete: (payload: ProviderIdPayload) => MaybePromise<HostSuccess>;
    setApiKey: (payload: ProviderApiKeyPayload) => MaybePromise<HostSuccess>;
    updateWithKey: (payload: ProviderUpdateWithKeyPayload) => MaybePromise<HostSuccess>;
    deleteApiKey: (payload: ProviderIdPayload) => MaybePromise<HostSuccess>;
    setDefault: (payload: ProviderIdPayload) => MaybePromise<HostSuccess>;
    accounts: () => MaybePromise<ProviderAccount[]>;
    vendors: () => MaybePromise<ProviderVendorInfo[]>;
    accountKeyInfo: () => MaybePromise<ProviderAccountKeyInfo[]>;
    getDefaultAccount: () => MaybePromise<ProviderDefaultAccountResult>;
    getAccount: (payload: ProviderAccountIdPayload) => MaybePromise<ProviderAccount | null>;
    getAccountApiKey: (payload: ProviderAccountIdPayload) => MaybePromise<string | null>;
    hasAccountApiKey: (payload: ProviderAccountIdPayload) => MaybePromise<{ hasKey: boolean }>;
    createAccount: (payload: ProviderCreateAccountPayload) => MaybePromise<HostSuccess>;
    updateAccount: (payload: ProviderUpdateAccountPayload) => MaybePromise<HostSuccess>;
    deleteAccount: (payload: ProviderAccountIdPayload) => MaybePromise<HostSuccess>;
    deleteAccountApiKey: (payload: ProviderAccountIdPayload) => MaybePromise<HostSuccess>;
    setDefaultAccount: (payload: ProviderAccountIdPayload) => MaybePromise<HostSuccess>;
    requestOAuth: (payload: ProviderOAuthRequestPayload) => MaybePromise<HostSuccess>;
    cancelOAuth: () => MaybePromise<HostSuccess>;
    submitOAuth: (payload: ProviderOAuthSubmitPayload) => MaybePromise<HostSuccess>;
  };
  files: {
    stagePaths: (payload: StagePathsPayload) => MaybePromise<StagedFileResult[]>;
    stageBuffer: (payload: StageBufferPayload) => MaybePromise<StagedFileResult>;
    readText: (payload: FilePathPayload) => MaybePromise<FileResult>;
    readBinary: (payload: FileReadBinaryPayload) => MaybePromise<FileResult>;
    writeText: (payload: FileWriteTextPayload) => MaybePromise<FileResult>;
    stat: (payload: FilePathPayload) => MaybePromise<FileResult>;
    listDir: (payload: FilePathPayload) => MaybePromise<FileListResult>;
    listTree: (payload: FileListTreePayload) => MaybePromise<FileListResult>;
  };
  media: {
    thumbnails: (payload: MediaThumbnailsPayload) => MaybePromise<MediaThumbnailResult>;
    saveImage: (payload: SaveImagePayload) => MaybePromise<JsonRecord>;
    imageGenerationSettings: () => MaybePromise<ImageGenerationSettingsResult>;
    saveImageGenerationSettings: (payload: ImageGenerationSettingsPayload) => MaybePromise<ImageGenerationSettingsResult>;
    imageGenerationProviders: () => MaybePromise<ImageGenerationProvidersResult>;
    testImageGeneration: (payload: ImageGenerationTestPayload) => MaybePromise<ImageGenerationTestResult>;
  };
  sessions: {
    delete: (payload: SessionDeletePayload) => MaybePromise<HostSuccess>;
    rename: (payload: SessionRenamePayload) => MaybePromise<HostSuccess>;
    summaries: (payload?: SessionSummariesPayload) => MaybePromise<SessionSummariesResult>;
    history: (payload: SessionHistoryPayload) => MaybePromise<SessionHistoryResult>;
  };
  chat: {
    sendWithMedia: (payload: ChatSendWithMediaPayload) => MaybePromise<ChatSendWithMediaResult>;
  };
  cron: {
    list: () => MaybePromise<CronJob[]>;
    create: (payload: CronJobCreateInput) => MaybePromise<CronJob>;
    update: (payload: CronUpdatePayload) => MaybePromise<CronJob>;
    delete: (payload: CronIdPayload) => MaybePromise<HostSuccess>;
    toggle: (payload: CronTogglePayload) => MaybePromise<HostSuccess>;
    trigger: (payload: CronIdPayload) => MaybePromise<HostSuccess>;
    sessionHistory: (payload: CronSessionHistoryPayload) => MaybePromise<CronSessionHistoryResult>;
  ...
  skills: {
    ...
    clawhubCapability: () => MaybePromise<ClawHubCapabilityResult>;
    clawhubList: () => MaybePromise<ClawHubListResult>;
    clawhubSearch: (payload: ClawHubSearchPayload) => MaybePromise<ClawHubSearchResult>;
    clawhubInstall: (payload: ClawHubInstallPayload) => MaybePromise<HostSuccess>;
    clawhubUninstall: (payload: ClawHubUninstallPayload) => MaybePromise<HostSuccess>;
    clawhubOpenSkillReadme: (payload: ClawHubOpenPayload) => MaybePromise<HostSuccess>;
    clawhubOpenSkillPath: (payload: ClawHubOpenPayload) => MaybePromise<HostSuccess>;
  };
  usage: {
    recentTokenHistory: (payload?: UsageHistoryPayload) => MaybePromise<UsageHistoryEntry[]>;
  };
};
