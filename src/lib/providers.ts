...
export const PROVIDER_TYPE_INFO: ProviderTypeInfo[] = [
  ...
  { id: 'orcarouter', name: 'OrcaRouter', icon: '🦈', placeholder: 'sk-orca-...', model: 'Multi-Model', requiresApiKey: true, showModelId: true, modelIdPlaceholder: 'openai/gpt-5.5', defaultModelId: 'openai/gpt-5.5', docsUrl: 'https://www.orcarouter.ai' },
